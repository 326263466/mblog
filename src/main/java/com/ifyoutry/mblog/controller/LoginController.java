package com.ifyoutry.mblog.controller;

import cn.hutool.crypto.digest.DigestUtil;
import com.ifyoutry.mblog.core.AjaxResult;
import com.ifyoutry.mblog.utils.JwtUtils;
...
public class LoginController extends BaseController {
    ...
    public AjaxResult login(@RequestBody Map<String, Object> map) {
        ...
        // 在认证提交前准备 token（令牌）
        UsernamePasswordToken token = new UsernamePasswordToken(username, DigestUtil.md5Hex(password));
        try {
            // 记住登录
